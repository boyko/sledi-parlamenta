module MemberHelper
  ...
  def paginate_always members
    if members.count >= Member.per_page
      will_paginate(members, :renderer => PaginationListLinkRenderer, :class => "pagination pagination-sm pull-right")
    else
